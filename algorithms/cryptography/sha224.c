 ...
 * Name: SHA-224
 *
 * Description: Computes the 224 bit SHA-224 hash of a byte oriented message.
 *
...
void sha224_init(struct sha224_context *state)
{
	state->size = 0;
...
static void sha224_consume(struct sha224_context *state)
{
...
void sha224_add(struct sha224_context *state, const void *data, size_t size)
{
	size_t amount;
...
void sha224_finish(struct sha224_context *state, unsigned char *hash)
{
	unsigned int i;
