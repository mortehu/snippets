 ...
 * Name: SHA-384
 *
 * Description: Computes the 384 bit SHA-384 hash of a byte oriented message.
 *
...
void sha384_init(struct sha384_context *state)
{
	state->size = 0;
...
static void sha384_consume(struct sha384_context *state)
{
...
void sha384_add(struct sha384_context *state, const void *data, size_t size)
{
	size_t amount;
...
void sha384_finish(struct sha384_context *state, unsigned char *hash)
{
	unsigned int i;
